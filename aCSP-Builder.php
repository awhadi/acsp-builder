...
function acsp_router() {
    $tabs = [ 'presets', 'builder', 'settings', 'about' ];
...
function acsp_assets( $hook ) {
    ...
    wp_enqueue_style( 'acsp-admin', ACSP_URL . 'assets/acsp.css', [], ACSP_VER );
    wp_enqueue_script( 'acsp-admin', ACSP_URL . 'assets/acsp.js', [ 'jquery' ], ACSP_VER, true );
}
