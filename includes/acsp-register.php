...
function acsp_register_settings() {
    ...
    register_setting(
        ...
        [
            ...
            'sanitize_callback' => function ( $v ) {
                return in_array( $v, [ 'reject', 'report' ], true ) ? $v : 'reject';
            },
        ]
    );
    register_setting( 'acsp_settings', 'acsp_add_dynamic_nonce', [ 'type' => 'boolean', 'default' => 1, 'sanitize_callback' => 'absint' ] );
    register_setting( 'acsp_settings', 'acsp_enable_meta_tag', [ 'type' => 'boolean', 'default' => 0, 'sanitize_callback' => 'absint' ] );
    register_setting( 'acsp_settings', 'acsp_enable_hashes', [ 'type' => 'boolean', 'sanitize_callback' => 'absint' ] );
    register_setting(
        'acsp_settings',
        'acsp_hash_values',
        [
    ...
    register_setting( 'acsp_settings', 'acsp_report_endpoint', [ 'type' => 'string', 'sanitize_callback' => 'esc_url_raw' ] );
}
